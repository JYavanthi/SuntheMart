...
const VendorOverview = ({
  ...
  return (
    ...
    <div className="actve-vndr-dtl-overview">

      {/* KPI CARDS */}

      <div className="actve-vndr-dtl-stat-grid">

        <div className="actve-vndr-dtl-stat-card">
...
<div className="actve-vndr-dtl-chart-grid">

  <div className="actve-vndr-dtl-box">

    <h3>
      Revenue Overview
    </h3>

    <div className="actve-vndr-dtl-chart-wrap">
  ...
  <div className="actve-vndr-dtl-box">
    ...
    <div className="actve-vndr-dtl-chart-wrap-pie">
      ...
      <div className="actve-vndr-dtl-box actve-vndr-dtl-top-products">
