...
// except updating/del images and category selction when in edit mode
...
//                 }
//               }}
//               style={{ cursor: images.length === 0 ? "pointer" : "default", overflow: "hidden" }}
//             >
...
//                 <img
//                   src={`http://localhost:4000${existingImages[0].AttachmentFile}`}
//                   alt="primary"
//                   style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "15px" }}
//                 />
...
//           objectFit: "cover",
//           borderRadius: "50%",
//           border: primaryIndex === index ? "3px solid #4caf50" : "none",
//           cursor: "pointer"
//         }}
//       />
...
// const deleteExistingImage = async (attachmentId:number) => {
...
// prev.filter(img => img.AttachmentID !== attachmentId)
// );
...
// />
// ):(
// <span style={{fontSize:"40px",color:"#7ddc7a"}}>+</span>
// )}
...
// {existingImages.map((img:any,index:number)=>(
// <div key={index} className="ap-thumb" style={{position:"relative"}}>
...
// <span
// onClick={()=>deleteExistingImage(img.AttachmentID)}
// style={{
// position:"absolute",
// top:"-5px",
// right:"-5px",
...
// {images.map((img,index)=>(
// <div key={index} className="ap-thumb" style={{position:"relative"}} onClick={()=>setPrimary(index)}>
